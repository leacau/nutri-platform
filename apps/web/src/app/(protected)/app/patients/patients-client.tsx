  ...
  const patientSchema = useMemo(
    () =>
      z.object({
        ...
        healthInsuranceName: z.string().max(120).optional().or(z.literal("")),
  ...
  const handleDniBlur = async (e: React.FocusEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (found) {
        ...
        if (found.healthInsuranceName)
          setValue("healthInsuranceName", found.healthInsuranceName);
